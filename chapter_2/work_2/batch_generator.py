...
def generate_record(fake: Faker) -> list:
    ...
    user_name = person_name.replace(" ", "").lower() # Create alowercase username without spaces.
    ...
    address = fake.address().replace("\n", ", ") # Replace newlines inthe address with commas.
    ...
    consumed_traffic = random.randint(0, 2_000_000) # Random consumedtraffic in kB.
...
def write_to_csv(file_path: str, rows: int) -> None:
    ...
    "session_duration", "download_speed", "upload_speed",
    "consumed_traffic"
    ]
