...
def _write_to_csv() -> None:
    ...
    if str(date.today()) == "2024-04-15":
        rows = random.randint(10_372, 10_372)
    else:
...
update_network_usage_task = GlueCrawlerOperator(
    ...
    config={'Name': 'staging_fact_network_usage_crawler'}
)
