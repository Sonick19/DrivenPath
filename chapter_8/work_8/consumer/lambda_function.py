...
bucket_name = "driven-data-bucket191919"
file_name = 'streaming_data.json'
queue_url = "https://sqs.eu-central-1.amazonaws.com/224222138746/driven_data_queue"
...
def lambda_handler(event, context) -> dict:
    ...
    while (datetime.now() - start_time).seconds < 5 * 60:
        process_messages()
    return {
        'statusCode': 200,
